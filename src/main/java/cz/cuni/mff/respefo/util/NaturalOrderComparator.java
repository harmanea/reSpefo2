 ...
 *
 * Taken from <a href="https://github.com/devexed/natural-sort">GitHub</a>
 */
public final class NaturalOrderComparator<T extends CharSequence> implements Comparator<T> {

    private static class InstanceHolder {
        private static final NaturalOrderComparator<String> INSTANCE = new NaturalOrderComparator<>();
    }

    public static NaturalOrderComparator<String> getInstance() {
